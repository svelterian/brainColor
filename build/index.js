...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-bb508ff7.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-bb508ff7.js", "/./_app/chunks/vendor-aad5b782.js", "/./_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/save\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/save.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "endpoint",
...
var module_lookup = {
  ...
  "src/routes/quiz.svelte": () => Promise.resolve().then(function() {
    return quiz;
  }),
  "src/routes/save.svelte": () => Promise.resolve().then(function() {
    return save;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-3b208c22.js", "css": ["/./_app/assets/pages/__layout.svelte-401e75c7.css"], "js": ["/./_app/pages/__layout.svelte-3b208c22.js", "/./_app/chunks/vendor-aad5b782.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-e45392fc.js", "css": [], "js": ["/./_app/error.svelte-e45392fc.js", "/./_app/chunks/vendor-aad5b782.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-935a30cf.js", "css": [], "js": ["/./_app/pages/index.svelte-935a30cf.js", "/./_app/chunks/vendor-aad5b782.js", "/./_app/chunks/navigation-43bc8d96.js", "/./_app/chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "/./_app/pages/contact.svelte-11ec17c8.js", "css": [], "js": ["/./_app/pages/contact.svelte-11ec17c8.js", "/./_app/chunks/vendor-aad5b782.js"], "styles": [] }, "src/routes/quiz.svelte": { "entry": "/./_app/pages/quiz.svelte-66699ef0.js", "css": ["/./_app/assets/pages/quiz.svelte-d75dff93.css"], "js": ["/./_app/pages/quiz.svelte-66699ef0.js", "/./_app/chunks/vendor-aad5b782.js", "/./_app/chunks/navigation-43bc8d96.js", "/./_app/chunks/singletons-12a22614.js", "/./_app/chunks/store-c7457dfe.js"], "styles": [] }, "src/routes/save.svelte": { "entry": "/./_app/pages/save.svelte-4de15e1c.js", "css": [], "js": ["/./_app/pages/save.svelte-4de15e1c.js", "/./_app/chunks/vendor-aad5b782.js", "/./_app/chunks/navigation-43bc8d96.js", "/./_app/chunks/singletons-12a22614.js", "/./_app/chunks/store-c7457dfe.js"], "styles": [] } };
...
var connectionString = "mongodb+srv://svelte:wJpIVHe3rSbLPKBG@cluster0.yoofn.mongodb.net/brainColor?retryWrites=true&w=majority";
...
async function get(request) {
  ...
  try {
    ...
    scoreList = await db.collection("score").find().sort({ score: -1 }).limit(10).toArray();
    return {
      status: 200,
      body: {
        list: scoreList
...
async function put(request) {
  const client = new MongoClient(uri);
  let rtn = {};
  let score2 = JSON.parse(request.body);
  if (!score2.name || !score2.score) {
    console.log(score2);
    throw "\uC798\uBABB\uB41C \uD615\uC2DD \uC785\uB2C8\uB2E4.";
  }
  score2["_id"] = nanoid();
  try {
    await client.connect();
    const db = client.db("brainColor");
    rtn = await db.collection("score").insertOne(score2);
    return {
      status: 200,
      body: {
        result: rtn
...
var css$1 = {
  code: "ul.svelte-1liwwaj{display:flex;list-style:none}li.svelte-1liwwaj{margin-right:10px}",
  map: '{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<nav>\\n    <ul>\\n        <li>\\n            <a href=\\"/\\">\uD648</a>\\n        </li>\\n        <li>\\n            <a href=\\"/quiz\\">\uAC8C\uC784\uD558\uAE30</a>\\n        </li>\\n        <li>\\n            <a href=\\"/contact\\">\uB9CC\uB4E0\uC774</a>\\n        </li>\\n    </ul>\\n</nav>\\n\\n<slot/>\\n\\n<style>\\n    ul {\\n        display : flex;\\n        list-style: none;\\n    }\\n    li {\\n        margin-right : 10px;\\n    }\\n</style>\\n"],"names":[],"mappings":"AAiBI,EAAE,eAAC,CAAC,AACA,OAAO,CAAG,IAAI,CACd,UAAU,CAAE,IAAI,AACpB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,YAAY,CAAG,IAAI,AACvB,CAAC"}'
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<nav><ul class="${"svelte-1liwwaj"}"><li class="${"svelte-1liwwaj"}"><a href="${"/"}">\uD648</a></li>
        <li class="${"svelte-1liwwaj"}"><a href="${"/quiz"}">\uAC8C\uC784\uD558\uAE30</a></li>
        <li class="${"svelte-1liwwaj"}"><a href="${"/contact"}">\uB9CC\uB4E0\uC774</a></li></ul></nav>
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let promisePosts = [];
  return `${$$result.head += `${$$result.title = `<title>Brain Color</title>`, ""}`, ""}

<h1 style="${"text-align:center;"}">\uB450\uB1CC \uAC1C\uBC1C \uAC8C\uC784</h1>
<h3 style="${"text-align:center;"}">\uAE08\uC8FC\uC758 \uC810\uC218</h3>
<table style="${"width:100%;"}"><thead><tr><th>NO</th>
            <th>\uC810\uC218</th>
            <th>\uC774\uB984</th></tr></thead>
    ...
    if (is_promise(__value))
      return `
        <tr><td colspan="${"3"}" style="${"text-align:center;"}"><h4>\uCD5C\uC2E0 \uC810\uC218\uB97C \uAC00\uC838\uC624\uB294\uC911.. \uC7A0\uC2DC\uB9CC \uAE30\uB2E4\uB9AC\uC138\uC694</h4></td></tr>  
        `;
    return function(list2) {
      return `
            ${each(list2, (item, index2) => `<tr><td style="${"text-align:center;"}">${escape2(index2 + 1)}</td>
                    <td style="${"text-align:center;"}">${escape2(item.score)}</td>
                    <td style="${"text-align:center;"}">${escape2(item.name)}</td>
                </tr>`)}
        `;
    }(__value);
  }(promisePosts)}</tbody></table>

<p style="${"text-align:center;"}"><button style="${"width:100%;height:60px;font-weight:bold;font-size:30px"}">\uAC8C\uC784\uD558\uAE30</button></p>`;
});
...
var Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>\uB9CC\uB4E0\uC774</title>`, ""}`, ""}
...
var score = writable2(0);
var quizList = writable2([
  {
    question: {
      color: "red",
      text: "green"
...
<p style="${"text-align:center;"}">${`<button style="${"width:45%;height:60px;font-weight:bold;font-size:30px"}">\uC2DC\uC791</button>`}
    <button style="${"width:45%;height:60px;font-weight:bold;font-size:30px"}">\uD648\uC73C\uB85C</button>
</p>`;
});
var quiz = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Quiz
});
var Save = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $score, $$unsubscribe_score;
  $$unsubscribe_score = subscribe(score, (value) => $score = value);
  let name = "--";
  let message = "\uC774\uB984\uC744 \uC785\uB825\uD558\uACE0 \uC800\uC7A5 \uBC84\uD2BC\uC744 \uB204\uB974\uC138\uC694.";
  $$unsubscribe_score();
  return `${$$result.head += `${$$result.title = `<title>\uC810\uC218 \uC800\uC7A5\uD558\uAE30</title>`, ""}`, ""}

<h1 style="${"text-align:center;"}">\uC810\uC218 \uC800\uC7A5\uD558\uAE30</h1>


<h4>${escape2(message)}</h4>

<p>\uD68D\uB4DD \uC810\uC218 : ${escape2($score)}</p>


<p>\uC774\uB984 : <input type="${"text"}" ${""}${add_attribute("value", name, 0)}></p>
